    ...
    it('Ranquea corretamente', (done) => {
        chai.request('http://localhost:3000')
            ...
            .end((err, res) => {
                ...
                while(i <= body_length)
                {
                    console.log(i); //consertar aq dpss
                    res.body[i].should.have.property('media') > res.body[i+1].should.have.property('media') &&
                    res.body[i].should.have.property('media').eq(res.body[i+1].should.have.property('media'));
                    i++;  
                }

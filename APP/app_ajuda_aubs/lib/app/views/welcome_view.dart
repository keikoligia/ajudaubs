                ...
                children: [
                  SizedBox(
                      ...
                      child: PageView(
                        ...
                        children: [
                          ...
                          SizedBox(
                              child:
                                  Image.asset('assets/imagens/fig_dados.png')),
                          SizedBox(
                              child:
                  ...
                  SizedBox(
                      ...
                      child: ComponentsUtils.ButtonTextColor(
                          context, 'Cadastre-se', () {
                        //Navigator.of(context).pushReplacementNamed('/formCad1');
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (_) => const FormCad1View()));
                  ...
                  SizedBox(
                      height: 40,
                      width: MediaQuery.of(context).size.width - 50,
                      child: ComponentsUtils.ButtonTextColor(context, 'Anônimo',
                          () {
